...
export function toSafeConstKey(value) {
    const normalized = normalizeIdentifierInput(value)
...
export function makeUniquePascalNames(items) {
...
export function makeUniqueConstKeys(items) {
    const result = new Map();
    const counts = new Map();
    items.forEach((item) => {
...
export function quotePropertyKey(value) {
