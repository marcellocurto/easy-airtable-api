...
type LinkToAnotherRecordCellV2 = {
    id: string;
    name: string;
}[];
...
type RatingColor = 'yellowBright' | 'orangeBright' | 'redBright' | 'pinkBright' | 'purpleBright' | 'blueBright' | 'cyanBright' | 'tealBright' | 'greenBright' | 'grayBright';
